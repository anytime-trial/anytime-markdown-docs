...
| ショートカット | 動作 | WYSIWYG | Source | Review | Readonly | Web | VS | 備考 |
| --- | --- | :---: | :---: | :---: | :---: | :---: | :---: | --- |
| Alt+Up | ブロックを上に移動 | o | x | x | x | x | o | VS Code のみ有効 |
| Alt+Down | ブロックを下に移動 | o | x | x | x | x | o | VS Code のみ有効 |
| Shift+Alt+Up | ブロックを上に複製 | o | x | x | x | x | o | VS Code のみ有効 |
| Shift+Alt+Down | ブロックを下に複製 | o | x | x | x | x | o | VS Code のみ有効 |
